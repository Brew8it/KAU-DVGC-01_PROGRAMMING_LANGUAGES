...
(defun operand (state)
    (cond
    ((eq 'ID (token state))    (symerr2-aux state)(match state 'ID))
...
(defun factor (state)
  (cond
    ((eq 'LP (token state))    (match state 'LP)(expr state)(match state 'RP))
    (t                         (operand state))
  )
)
...
(defun check-end (state)
  (cond
    ((not (eq (token state) 'EOF)) (semerr3 state) (match state (token state))(check-end state))
  )
)
...
(defun parse-all ()
(setf testok(list "testfiles/testok1.pas" "testfiles/testok2.pas" "testfiles/testok3.pas"
                  "testfiles/testok4.pas" "testfiles/testok5.pas" "testfiles/testok6.pas" "testfiles/testok7.pas"))

(setf testaz(list "testfiles/testa.pas" "testfiles/testb.pas" "testfiles/testc.pas"
...
(setf testsem(list "testfiles/sem1.pas" "testfiles/sem2.pas" "testfiles/sem3.pas"
                   "testfiles/sem4.pas" "testfiles/sem5.pas"))

(setf testfun(list "testfiles/fun1.pas" "testfiles/fun2.pas" "testfiles/fun3.pas"
                   "testfiles/fun4.pas" "testfiles/fun5.pas"))

(setf alltests(append testaz testok testfun testsem))

(mapcar #'parse alltests)
)
